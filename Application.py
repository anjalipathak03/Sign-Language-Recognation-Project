...
class Application():
    ...
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title(
            "Sign Language To Detection for differently abled people")
        ...
        self.T.config(text="Sign Language To Detection",
    ...
    def video_loop(self):
        ...
        if res:
            ...
            def update_text(self, text):
                # Use pyspellchecker to correct misspelled words
                corrected_text = ""
                for word in text.split():
                    corrected_word = self.spell.correction(word)
                    corrected_text += corrected_word + " "

    # Display corrected text in panel4
                self.word = corrected_text
                self.panel4.config(text=self.word, font=("Courier", 30))

    # Display suggestions in buttons
                predicts = self.spell.suggest(text.lower())
